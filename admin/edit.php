...
if (isset($_GET['id'])) {
    $result = R::getAll("SELECT * FROM pages WHERE id = ?", [$_GET['id']]);
}
?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                            <textarea id="photo" class="textarea" placeholder="Place some text here"
                                                      style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $result[0]['photo'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                            <textarea id="kztheme" class="textarea" placeholder="Place some text here"
                                                      style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $result[0]['name_kz'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                            <textarea id="rutheme" class="textarea" placeholder="Place some text here"
                                                      style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $result[0]['name_ru'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                            <textarea id="entheme" class="textarea" placeholder="Place some text here"
                                                      style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $result[0]['name_en'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                            <textarea id="kztext" class="textarea" placeholder="Place some text here"
                                                      style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $result[0]['kz'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                            <textarea id="rutext" class="textarea" placeholder="Place some text here"
                                                      style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $result[0]['ru'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                            <textarea id="entext" class="textarea" placeholder="Place some text here"
                                                      style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $result[0]['en'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <button id="send" class="btn btn-outline-primary">Редактировать</button>
                            <!-- /.row -->
                        </div>
                        <!-- /.card-body -->
