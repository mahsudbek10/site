                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="heading-sub heading-sub2 text-center">
                            <h5><span>Администрация</span></h5>
                            <p>школы №12<br>имени М.Горького</p>
                        </div>
                        <div class="product-carousel3">
                            ...
                            <div class="pc-wrap">
                                <div class="product-item">
                                    ...
                                    <div class="product-info">
                                        <h4 class="product-title"><a href="./single-product.html">Сарсенова Акнур Бегилдаевна</a></h4>
                                        <span class="product-price">8701 410 89 89<em>- Бастауыш 1-5 сыныптар бойынша оқу ісі жөніндегі орынбасары -</em></span>
                                    </div>
                                </div>
                            </div>
                            <div class="pc-wrap">
                            ...
                            <div class="pc-wrap">
                                <div class="product-item">
                                    ...
                                    <div class="product-info">
                                        <h4 class="product-title"><a href="./images/teachers/Юсупова Махсуда Турсункуловна .JPG">Юсупова Махсуда Турсункуловна</a></h4>
                                        <span class="product-price">8775 421 85 59<em>- 8-11 сыныптар бойынша Оқу ісі жөніндегі орынбасары -</em></span>
                            ...
                            <div class="pc-wrap">
                                <div class="product-item">
                                    ...
                                    <div class="product-info">
                                        <h4 class="product-title"><a href="./single-product.html">Бекұрсын Кұлай Сайлауқызы</a></h4>
                                        <span class="product-price">8702 757 76 89<em>- Тәрбие ісі жөніндегі орынбасары, бірінші ауысым бойынша -</em></span>
                            ...
                            <div class="pc-wrap">
                                <div class="product-item">
                                    ...
                                    <div class="product-info">
                                        <h4 class="product-title"><a href="./images/teachers/Балғара Айгүл Нұрпейісқызы.JPG">Балғара Айгүл Нұрпейісқызы</a></h4>
                                        <span class="product-price">8747 277 10 40<em>- Тәрбие ісі жөніндегі орынбасары, екінші ауысым бойынша -</em></span>
                            ...
                            <div class="pc-wrap">
                                <div class="product-item">
                                    ...
                                    <div class="product-info">
                                        <h4 class="product-title"><a href="./images/teachers/Туламетова Матлюба Акимжановна.JPG">Туламетова Матлюба Акимжановна</a></h4>
                                        <span class="product-price">8702 457 60 04<em>- Іс қағаз жүргізушісі -</em></span>
                            ...
                            <div class="pc-wrap">
                                <div class="product-item">
                                    ...
                                    <div class="product-info">
                                        <h4 class="product-title"><a href="./images/teachers/Иксанова Наиля Жиганшаевна .JPG">Иксанова Наиля Жиганшаевна</a></h4>
                                        <span class="product-price">8702 457 60 04<em>- Кітапхана меңгерушісі -</em></span>
                            ...
                            <div class="pc-wrap">
                                <div class="product-item">
                                    ...
                                    <div class="product-info">
                                        <h4 class="product-title"><a href="./images/teachers/Курбаналиева Нодира Хамидовна.JPG">Курбаналиева Нодира Хамидовна</a></h4>
                                        <span class="product-price">8705 556-54-56<em>- Педагог-психолог -</em></span>
